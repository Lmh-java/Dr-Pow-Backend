...
- The summary will generate a relevant title that is AT MOST 15 characters
- The summary will provide 2-5 bullet points in each slide that is relevant to the title
